...
pub struct State {
    pub admin: Pubkey,
    pub exchange_paused: bool,                // 整个exchange是否暂停交易
    pub funding_paused: bool,                 // 资金费率计算是否暂停
    pub admin_controls_prices: bool,          // 管理员是否控制价格(紧急情况下)
...
pub struct OracleGuardRails {
    ...
    pub use_for_liquidations: bool,                  // 是否在清算时启用这些保护
}
